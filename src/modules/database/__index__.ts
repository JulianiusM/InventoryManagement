...
export const entities = [Barcode, ConnectorDevice, ExternalAccount, ExternalLibraryEntry, GameExternalMapping, GameRelease, GameTitle, Item, ItemMovement, Loan, Location, Party, Platform, PlayniteDevice, Session, SyncJob, User];
